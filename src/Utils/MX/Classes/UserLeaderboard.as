    ...
    class UserLeaderboard
    {
        ...
        UserLeaderboard(const Json::Value &in json)
        {
            try {
                ...
                Logging::Warn("Failed to parse User Leaderboard for user " + Username + ": " + getExceptionInfo());
            }
        }
        ...
        Json::Value ToJSON()
        {
            ...
            try {
                ...
                Logging::Warn("Failed to convert User Leaderboard to JSON for user " + Username + ": " + getExceptionInfo());
            }
            return json;
        }
    }
